                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <div class="p-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="#!" class="small text-reset text-decoration-underline"> <?= lang('Unread') ?>
                                    (3)</a>
                            </div>
                        </div>
                    </div>
                    <div data-simplebar style="max-height: 230px;">
                        ...
                        <a href="#!" class="text-reset notification-item">
                            <div class="d-flex">
                                <img src="assets/images/users/avatar-6.jpg" class="me-3 rounded-circle avatar-sm"
                                    alt="user-pic">
                                <div class="flex-grow-1">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="auth-lock-screen"><i
                            class="mdi mdi-lock font-size-16 align-middle me-1"></i> <?= lang('Lock_screen') ?></a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="auth-login"><i
                            class="mdi mdi-logout font-size-16 align-middle me-1"></i> <?= lang('Logout') ?></a>
                </div>
            </div>
                ...
                <ul class="navbar-nav">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <a href="extended-lightbox" class="dropdown-item"
                                                    data-key="t-lightbox"><?= lang('Lightbox') ?></a>
                                                <a href="extended-rangeslider" class="dropdown-item"
                                                    data-key="t-range-slider"><?= lang('Range_Slider') ?></a>
                                                <a href="extended-sweet-alert" class="dropdown-item"
                                                    data-key="t-sweet-alert"><?= lang('SweetAlert_2') ?></a>
                                                <a href="extended-session-timeout" class="dropdown-item"
                                                    data-key="t-session-timeout"><?= lang('Session_Timeout') ?></a>
                                                <a href="extended-rating" class="dropdown-item"
                                                    data-key="t-rating"><?= lang('Rating') ?></a>
                                                <a href="extended-notifications" class="dropdown-item"
                                                    data-key="t-notifications"><?= lang('Notifications') ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                            ...
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-invoice"
                                    role="button">
                                    <span data-key="t-invoices"><?= lang('Invoices') ?></span>
                                    <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-invoice">
                                    <a href="apps-invoices-list" class="dropdown-item"
                                        data-key="t-invoice-list"><?= lang('Invoice_List') ?></a>
                                    <a href="apps-invoices-detail" class="dropdown-item"
                                        data-key="t-invoice-detail"><?= lang('Invoice_Detail') ?></a>
                                </div>
                            </div>
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-contact"
                                    role="button">
                                    <span data-key="t-contacts"><?= lang('Contacts') ?></span>
                                    <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-contact">
                                    <a href="apps-contacts-grid" class="dropdown-item"
                                        data-key="t-user-grid"><?= lang('User_Grid') ?></a>
                                    <a href="apps-contacts-list" class="dropdown-item"
                                        data-key="t-user-list"><?= lang('User_List') ?></a>
                                    <a href="apps-contacts-profile" class="dropdown-item"
                                        data-key="t-profile"><?= lang('Profile') ?></a>
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-components" role="button">
                            <i data-feather="box"></i><span data-key="t-components"><?= lang('Components') ?></span>
                            <div class="arrow-down"></div>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="topnav-components">
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-form"
                                    role="button">
                                    <span data-key="t-forms"><?= lang('Forms') ?></span>
                                    <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-form">
                                    <a href="form-elements" class="dropdown-item"
                                        data-key="t-form-elements"><?= lang('Basic_Elements') ?></a>
                                    <a href="form-validation" class="dropdown-item"
                                        data-key="t-form-validation"><?= lang('Validation') ?></a>
                                    <a href="form-advanced" class="dropdown-item"
                                        data-key="t-form-advanced"><?= lang('Advanced_Plugins') ?></a>
                                    <a href="form-editors" class="dropdown-item"
                                        data-key="t-form-editors"><?= lang('Editors') ?></a>
                                    <a href="form-uploads" class="dropdown-item"
                                        data-key="t-form-upload"><?= lang('File_Upload') ?></a>
                                    <a href="form-wizard" class="dropdown-item"
                                        data-key="t-form-wizard"><?= lang('Wizard') ?></a>
                                    <a href="form-mask" class="dropdown-item"
                                        data-key="t-form-mask"><?= lang('Mask') ?></a>
                                </div>
                            </div>
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-table"
                                    role="button">
                                    <span data-key="t-tables"><?= lang('Tables') ?></span>
                                    <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-table">
                                    <a href="tables-basic" class="dropdown-item"
                                        data-key="t-basic-tables"><?= lang('Bootstrap_Basic') ?></a>
                                    <a href="tables-datatable" class="dropdown-item"
                                        data-key="t-data-tables"><?= lang('DataTables') ?></a>
                                    <a href="tables-responsive" class="dropdown-item"
                                        data-key="t-responsive-table"><?= lang('Responsive') ?></a>
                                    <a href="tables-editable" class="dropdown-item"
                                        data-key="t-editable-table"><?= lang('Editable') ?></a>
                                </div>
                            </div>
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-charts"
                                    role="button">
                                    <span data-key="t-charts"><?= lang('Charts') ?></span>
                                    <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                    <a href="charts-apex" class="dropdown-item"
                                        data-key="t-apex-charts"><?= lang('Apexcharts') ?></a>
                                    <a href="charts-echart" class="dropdown-item"
                                        data-key="t-e-charts"><?= lang('Echarts') ?></a>
                                    <a href="charts-chartjs" class="dropdown-item"
                                        data-key="t-chartjs-charts"><?= lang('Chartjs') ?></a>
                                    <a href="charts-knob" class="dropdown-item"
                                        data-key="t-knob-charts"><?= lang('Jquery_Knob') ?></a>
                                    <a href="charts-sparkline" class="dropdown-item"
                                        data-key="t-sparkline-charts"><?= lang('Sparkline') ?></a>
                                </div>
                            </div>
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-icons"
                                    role="button">
                                    <span data-key="t-icons"><?= lang('Icons') ?></span>
                                    <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-icons">
                                    <a href="icons-boxicons" class="dropdown-item"
                                        data-key="t-boxicons"><?= lang('Boxicons') ?></a>
                                    <a href="icons-materialdesign" class="dropdown-item"
                                        data-key="t-material-design"><?= lang('Material_Design') ?></a>
                                    <a href="icons-dripicons" class="dropdown-item"
                                        data-key="t-dripicons"><?= lang('Dripicons') ?></a>
                                    <a href="icons-fontawesome" class="dropdown-item"
                                        data-key="t-font-awesome"><?= lang('Font_Awesome_5') ?></a>
                                </div>
                            </div>
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-map"
                                    role="button">
                                    <span data-key="t-maps"><?= lang('Maps') ?></span>
                                    <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-map">
                                    <a href="maps-google" class="dropdown-item"
                                        data-key="t-g-maps"><?= lang('Google') ?></a>
                                    <a href="maps-vector" class="dropdown-item"
                                        data-key="t-v-maps"><?= lang('Vector') ?></a>
                                    <a href="maps-leaflet" class="dropdown-item"
                                        data-key="t-l-maps"><?= lang('Leaflet') ?></a>
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-more" role="button">
                            <i data-feather="file-text"></i><span
                                data-key="t-extra-pages"><?= lang('Extra_pages') ?></span>
                            <div class="arrow-down"></div>
                        </a>
