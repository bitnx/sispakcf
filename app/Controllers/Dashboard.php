...
class Dashboard extends BaseController
{
    public function index()
	{
		...
		$data = [
			...
			'page_title' => view('partials/page-title', ['title' => 'Dashboard', 'li_1' =>  ''])
		];
    ...
    public function pasien()
	{
		...
		$data = [
			...
			'page_title' => view('partials/page-title', ['title' => 'Pasien', 'li_1' =>  ''])
		];
    ...
    public function gejala()
	{
		...
		$data = [
			'title_meta' => view('partials/title-meta', ['title' => 'Gejala']),
			'page_title' => view('partials/page-title', ['title' => 'Gejala', 'li_1' =>  ''])
		];
    ...
    public function pengetahuan()
	{
		...
		$data = [
			'title_meta' => view('partials/title-meta', ['title' => 'Pengetahuan']),
			'page_title' => view('partials/page-title', ['title' => 'Pengetahuan', 'li_1' =>  ''])
		];
		
		return view('pengetahuan', $data);
	}
    ...
    public function penyakit()
	{
		...
		$data = [
			'title_meta' => view('partials/title-meta', ['title' => 'Penyakit']),
			'page_title' => view('partials/page-title', ['title' => 'Penyakit', 'li_1' =>  ''])
		];
...
// END
	...
	public function show_contacts_profile(){
		$data = [
			...
			'page_title' => view('partials/page-title', ['title' => 'Profile', 'li_1' =>  'Profile'])
		];
