    ...
    public partial class _initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Gejala", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Alamat = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasienId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Konsultasi", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Konsultasi_Pasien_PasienId",
                        column: x => x.PasienId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Solusi", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MB = table.Column<double>(type: "double", nullable: false),
                    MD = table.Column<double>(type: "double", nullable: false),
                    SolusiId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pengetahuan", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Pengetahuan_Gejala_GejalaId",
                        column: x => x.GejalaId,
                        principalTable: "Gejala",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pengetahuan_Solusi_SolusiId",
                        column: x => x.SolusiId,
                        principalTable: "Solusi",
                        principalColumn: "Id");
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Konsultasi_PasienId",
                table: "Konsultasi",
                column: "PasienId");

            migrationBuilder.CreateIndex(
                name: "IX_Pengetahuan_GejalaId",
                table: "Pengetahuan",
                column: "GejalaId");

            migrationBuilder.CreateIndex(
                name: "IX_Pengetahuan_SolusiId",
                table: "Pengetahuan",
                column: "SolusiId");
